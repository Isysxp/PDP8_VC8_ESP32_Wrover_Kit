...
image is in the repo and si Simh compatible.
<br>
<br>
Hardware changes:
<br>
...
this index in the bitamp array incremented. After a number of cycles, the RGB565 value from the decay array will be zero
